/* INH — Icon component
   Stroke icons copied from Lucide (https://lucide.dev, ISC) as path data.
   Substituted set — flag to user if a brand icon set exists. */
export const INH_ICONS = {
...
export function Icon({ name, size = 22, stroke = 2, color = 'currentColor', style = {} }) {
  return (
    <svg
      ...
      dangerouslySetInnerHTML={{ __html: INH_ICONS[name] || '' }}
    />
  );
}
